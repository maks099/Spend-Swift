...
import com.spend.swift.R.string.login
...
fun Login(
    ...
    SpendSwiftTheme {
        Column(
            ...
            TextButton(
                onClick = { navController.navigate(Views.Registration.path){
                    popUpTo(Views.Login.path){ inclusive = true }
                } },
                modifier = Modifier
                    .padding(top = 24.dp)
            ) {
